...
def compare_models(samples, name1, base_folder, name2, old_model_folder):
    ...
    print(f"{name1} current loss: {old_loss:.3f}, old loss: {new_loss:.3f}")
...
old_model_path = f"temp_data/saved_models/{N}N_old"
...
old_folder_X = os.path.join(old_model_path, "X")
old_folder_XH = os.path.join(old_model_path, "XH")
