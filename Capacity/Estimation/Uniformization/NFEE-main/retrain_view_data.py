...
for filename in os.listdir(filepath):
    ...
    _step_sizes,N,_val_error,_duration,_unif_KL,_unif_KSG = util.io.load(os.path.join(filepath, filename))
    ...
    val_error,_ = viewData.align_and_concatenate(val_error,_val_error,(step_sizes),(_step_sizes))
    # test_error,_ = viewData.align_and_concatenate(duration,_duration,(step_sizes),(_step_sizes))
    duration,step_sizes = viewData.align_and_concatenate(duration,_duration,(step_sizes),(_step_sizes))
