...
for iter in range(n_trials):
    for T in T_range:
        ...
        print(f"estimated cond MAF H: {H_cond_MAF[iter,T]}")
        print(f"estimated MAF H_XY - H_X: {H_xy_MAF[iter,T]-H_x_MAF[iter,T]}")
        print(f"estimated knn H_XY - H_X: {H_xy_kl_ksg[iter,T]-H_x_kl_ksg[iter,T]}")
