...
for i in range(n_trials):        
    ...
    for k, T in enumerate(T_range):
        ...
        if T==1:
            ...
            ent.print_border("Calculate H(x), T: 1, iter: {}".format(i+1))
            ...
            ent.print_border("Calculate H(h), T: 1, iter: {}".format(i+1))
            ...
            sim_model.set_use_h_flag(h_flag=True)            
            ent.print_border("Calculate H(x,h), T: 1, iter: {}".format(i+1))
