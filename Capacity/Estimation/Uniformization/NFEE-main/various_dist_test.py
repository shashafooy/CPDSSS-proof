...
for i in range(n_trials):
    ...
    H_laplace[i] = ent.calc_entropy(sim_model = sim_laplace, n_samples = n_train_samples,base_samples=laplace_base)    
    ...
    H_cauchy[i] = ent.calc_entropy(sim_model = sim_cauchy, n_samples = n_train_samples,base_samples=cauchy_base)    
    ...
    H_logistic[i] = ent.calc_entropy(sim_model = sim_logistic, n_samples = n_train_samples,base_samples=logistic_base)    
